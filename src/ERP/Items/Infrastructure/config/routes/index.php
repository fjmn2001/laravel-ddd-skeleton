...
use Medine\ERP\Items\Infrastructure\Controller\ItemsBreadcrumbsPostController;
use Medine\ERP\Items\Infrastructure\Controller\ItemsCatalogsGetController;
...
Route::middleware('auth:api')->group(function () {
    ...
    Route::get('/items/catalogs/{companyId}', ItemsCatalogsGetController::class);
    ...
    Route::post('/items/breadcrumbs', ItemsBreadcrumbsPostController::class);
