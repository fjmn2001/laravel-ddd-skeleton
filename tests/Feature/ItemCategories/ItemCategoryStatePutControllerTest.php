...
final class ItemCategoryStatePutControllerTest extends FeatureBase
{
     ...
     * @test
     */
    public function it_should_inactivate_an_existing_item_category()
    {
        Passport::actingAs(
            User::factory()->create()
        );
        ...
        $response = $this->putJson('/api/item_categories/state/' . $categoryId, [
            'state' => 'inactive'
        ]);
